# -*- coding: utf-8 -*-
"""cifar10_vgg_block1-3_Dr_DataAugmentation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1TdUxZMrIBvQZFTu9aEz1pyjupKhtGApx
"""
...
train_generator = train_image_generator.flow(x_train, y_train, \
                                             batch_size=64)
# validation_generator = validation_image_generator.flow(x_test, y_test, \
...
hist = model.fit(train_generator, epochs=epochs, validation_data=(x_test, y_test))
